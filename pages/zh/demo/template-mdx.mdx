...
<section>
    ...
    >
        ...
        '
        >
            <h3 style='margin: 0 0 1rem 0'>卡片标题1</h3>
            <p style='margin: 0'>响应式卡片内容区域，支持多设备适配显示</p>
        </div>
        <div
            style='
            background: white;
        ...
        '
        >
            <h3 style='margin: 0 0 1rem 0'>卡片标题2</h3>
            <p style='margin: 0'>自动调整列数，最小宽度300px</p>
        </div>
        <div
            style='
            background: white;
        ...
        '
        >
            <h3 style='margin: 0 0 1rem 0'>卡片标题3</h3>
            <p style='margin: 0'>流畅的网格布局过渡效果</p>
        </div>
    </div>
<section>
...
">
    ...
    <div style="flex: 1; min-width: 300px">
        <h2 style="margin-top: 0">媒体标题</h2>
        <p>弹性布局实现响应式媒体对象，左侧图片固定宽度，右侧内容区域自适应。在移动端自动堆叠显示。</p>
    </div>
</div>
...
<ResponsiveGrid minWidth={280} gap='2rem'>
    <div>自适应项1</div>
    <div>自适应项2</div>
    <div>自适应项3</div>
</ResponsiveGrid>
